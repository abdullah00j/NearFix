...
function SearchBar({ placeholder, shortcutEnable, bgColor }: SearchBarProps) {
  return (
    <div className="w-full  min-w-[0px] mr-4">
      <div
        className={`mx-auto flex py-1 items-center bg-panel-soft border-line group shadow-md rounded-[8px]  border-1 border-gray-600 bg-${bgColor} px-4 transition-all duration-200 focus-within:border-primary focus-within:border-[1.5px]   `}
      >
        {/* Search Icon */}
        <Search
          size={15}
          className="mr-2 text-gray-300 group-focus-within:text-primary transition-all "
        />
